...
const FormularioFiltrosProductos = () => {
  const {
    filtros,
    manejarCambioFiltro,
    aplicarFiltros,
  ...
  return (
    ...
    >
      ...
      {/* Botones de acción del formulario: Enviar Filtros y Limpiar Filtros. */}
      <div className="flex gap-2 w-full lg:w-auto">
        <Boton
          tipo="submit"
          variante="primario"
          className="py-2 px-6 flex-1 lg:flex-none justify-center"
        >
          Filtrar
        </Boton>
        <Boton
...
export default FormularioFiltrosProductos;
